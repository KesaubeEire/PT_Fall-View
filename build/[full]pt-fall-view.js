...
(function () {
  ...
  function Launch_Hijack(param = { path: "/search", method: "POST" }) {
    ...
    function captureResponseData(xhr) {
      ...
      try {
        ...
        const event2 = new CustomEvent(`res>${method}->${path}`, { detail: responseData });
    ...
    XMLHttpRequest.prototype.open = function(method2, url) {
      console.log(`[PT-Fall] XHR.open: ${method2} ${url}`, performance.now());
      const metadata = {
    ...
    XMLHttpRequest.prototype.send = function(body) {
      ...
      if (metadata == null ? void 0 : metadata.isTarget) {
        ...
        const event2 = new CustomEvent(`req>${method}->${path}`, { detail: reqBody });
        window.dispatchEvent(event2);
      }
  ...
  ***************************************************************************** */
  ...
  const _HoverView = class _HoverView {
    /**
     * 获取 HoverView 实例
     * @returns {HoverView}
     */
    static getInstance() {
      if (!_HoverView.instance) {
        _HoverView.instance = new _HoverView();
      }
      return _HoverView.instance;
    }
    constructor() {
      if (_HoverView.instance) {
        return _HoverView.instance;
      }
      _HoverView.instance = this;
      this.container = null;
  ...
  __publicField(_HoverView, "instance", null);
  let HoverView = _HoverView;
  ...
  var root_1$2 = /* @__PURE__ */ template(`<div class="card-category svelte-18y66sj"><img class="card_category-img svelte-18y66sj"> </div>`);
  var root_2$3 = /* @__PURE__ */ template(`<a class="__main_title svelte-18y66sj" target="_blank" rel="noopener noreferrer"> </a>`);
  var root_4 = /* @__PURE__ */ template(`<div class="pic_error svelte-18y66sj"><div><img style="height: 100%; width:60px; border-radius:20px;" alt="pic error" class="svelte-18y66sj"></div> <div class="ant-typography" style="color: white; font-size:16px;">GAY WARNING<br>同志警告</div></div>`);
  var root_6$1 = /* @__PURE__ */ template(`<img class="lazy-image svelte-18y66sj">`);
  var root_7$1 = /* @__PURE__ */ template(`<div class="pic_error svelte-18y66sj" style=""><div><img style="height: 100%;width: 100px;" alt="no pic" class="svelte-18y66sj"></div> <div>本种没有图片</div></div>`);
  var root_8 = /* @__PURE__ */ template(`<div class="pic_error svelte-18y66sj" style=""><div><img style="height: 100%;width: 100px;" alt="pic error" class="svelte-18y66sj"></div> <div class="ant-typography">图片加载失败</div></div>`);
  var root_9 = /* @__PURE__ */ template(`<div class="hover-trigger svelte-18y66sj" role="button" aria-label="悬浮预览" tabindex="0"><img style="pointer-events: none;" alt="PREVIEW" class="svelte-18y66sj"></div>`);
  var root_11 = /* @__PURE__ */ template(`<img style="
                    background: url(/static/media/icons.8bb5446ebbbd07050285.gif) 0 -202px;
                    height: 14px;
                    width: 14px;" alt="PIN" class="svelte-18y66sj">`);
  var root_10 = /* @__PURE__ */ template(`<div class="card_info__topping svelte-18y66sj"></div> &nbsp;`, 1);
  var root_12 = /* @__PURE__ */ template(`<div class="_tag svelte-18y66sj"> </div>`);
  var root_14 = /* @__PURE__ */ template(`<div class="_tag _tag_diy svelte-18y66sj">DIY</div>`);
  var root_15 = /* @__PURE__ */ template(`<div class="_tag _tag_dub svelte-18y66sj">国配</div>`);
  var root_16 = /* @__PURE__ */ template(`<div class="_tag _tag_sub svelte-18y66sj">中字</div>`);
  var root_18 = /* @__PURE__ */ template(`<div class="_tag svelte-18y66sj"> </div>`);
  var root_13 = /* @__PURE__ */ template(`<div class="cl-tags svelte-18y66sj"><!> <!> <!> <!></div>`);
  var root_21 = /* @__PURE__ */ template(`<img style="
                  background: url(/static/media/icons.8bb5446ebbbd07050285.gif) 0 -202px;
                  height: 14px;
                  width: 14px;" alt="PIN" class="svelte-18y66sj">`);
  var root_20 = /* @__PURE__ */ template(`<div class="card_info__topping svelte-18y66sj"></div> &nbsp;`, 1);
  var root_22 = /* @__PURE__ */ template(`<div class="_tag svelte-18y66sj"> </div>`);
  var root_19 = /* @__PURE__ */ template(`<div class="card-index svelte-18y66sj"><!> <!></div>`);
  var root_23 = /* @__PURE__ */ template(`<div class="card-index card-index-right svelte-18y66sj"> </div>`);
  var root_25 = /* @__PURE__ */ template(`<div class="card_info-item card_info__sub_title svelte-18y66sj" style="padding-top: 4px;"><div> </div></div>`);
  var root_27 = /* @__PURE__ */ template(`<div class="_tag _tag_diy svelte-18y66sj">DIY</div>`);
  var root_28 = /* @__PURE__ */ template(`<div class="_tag _tag_dub svelte-18y66sj">国配</div>`);
  var root_29 = /* @__PURE__ */ template(`<div class="_tag _tag_sub svelte-18y66sj">中字</div>`);
  var root_31 = /* @__PURE__ */ template(`<div class="_tag svelte-18y66sj"> </div>`);
  var root_26 = /* @__PURE__ */ template(`<div class="cl-tags svelte-18y66sj"><!> <!> <!> <!></div>`);
  var root_32 = /* @__PURE__ */ template(`<div class="card_info-item card_info__dl_and_cl svelte-18y66sj"><button title="(原列表的这俩按钮会消失)">下载 & 收藏</button></div>`);
  var root_33 = /* @__PURE__ */ template(`<div class="card_info-item card_info__upload_time svelte-18y66sj"><div> </div></div>`);
  var root_34 = /* @__PURE__ */ template(`<div class="card_info-item card_info__statistics svelte-18y66sj"><!> &nbsp; <b> </b> &nbsp;&nbsp; <img alt="SVG_Seeders"> &nbsp; <b> </b> &nbsp;&nbsp; <img alt="SVG_Leechers"> &nbsp; <b> </b></div>`);
  var root_24 = /* @__PURE__ */ template(`<div class="card_info svelte-18y66sj"><!>  <!> <!> <!> <!></div>`);
  var root$9 = /* @__PURE__ */ template(`<div class="card_holder svelte-18y66sj"><!> <div class="card_title"><!></div> <div class="card_pic svelte-18y66sj"><!> <!>  <div class="hover-overlay svelte-18y66sj"><div class="overlay-content svelte-18y66sj"><div class="__inner_index_and_size svelte-18y66sj"><div class="card-index __inner_index svelte-18y66sj" style="background-color:black; color:white"><!> <!></div> <button class="__iframe_button svelte-18y66sj">内窗预览</button> <div class="card-index card-index-right __inner_index __inner_size svelte-18y66sj"> </div></div> <div class="card-category card_info-item svelte-18y66sj"><img class="card_category-img card_category_square svelte-18y66sj" style="width: 36px;height: 36px;"> </div> <div style="width: 100%;" class="card_info-item card_info__sub_title svelte-18y66sj"><a class="__main_title __straight svelte-18y66sj" target="_blank" rel="noopener noreferrer"> </a></div> <div style="width: 100%;" class="card_info-item card_info__sub_title svelte-18y66sj"><div class="__sub_title svelte-18y66sj"> </div></div>  <!> <div class="card_info-item card_info__upload_time svelte-18y66sj"><div> </div></div> <div class="card_info-item card_info__statistics svelte-18y66sj"><div class="__center svelte-18y66sj"><!> <b> </b></div> <div class="__center svelte-18y66sj"><img style="width: 14px; height: 14px;" alt="SVG_Seeders" class="svelte-18y66sj"> <b> </b></div> <div class="__center svelte-18y66sj"><img style="width: 14px; height: 14px;" alt="SVG_Leechers" class="svelte-18y66sj"> <b> </b></div> <div><button title="(原列表的这俩按钮会消失)" style="
...
`, rawObject);
    ...
    function changeFallView(isFallView) {
      ...
      const cleanup12 = Tool_Watch_Dom("#_fallHolder", (el) => {
        el.style.display = isFallView ? "block" : "none";
      });
      fallViewCleanups.push(cleanup12);
      const cleanup22 = Tool_Watch_Dom("#_shield", (el) => {
        el.style.display = isFallView ? "block" : "none";
      });
      fallViewCleanups.push(cleanup22);
        ...
        var node_9 = sibling(div_14, 2);
        {
          var consequent_3 = ($$anchor3) => {
            ...
            Switch(node_10, {
              ...
              set checked($$value) {
                store_set(_state_hover_pic, $$value);
              },
              $$legacy: true
            });
  ...
  var root_1 = /* @__PURE__ */ template(`<div id="_iframe_holder" class="svelte-126sfo0"><div class="_iframe_back svelte-126sfo0"></div> <div class="_iframe_parent svelte-126sfo0"><div class="resize-handle resize-handle-left svelte-126sfo0"></div> <!> <iframe sandbox="allow-same-origin allow-scripts allow-popups allow-forms" allow="fullscreen" frameborder="0" class="svelte-126sfo0"></iframe> <div class="_iframeCloseBtn svelte-126sfo0"><!></div> <div class="resize-handle resize-handle-right svelte-126sfo0"></div></div></div>`);
  function App($$anchor, $$props) {
    ...
    let scrollCheckInterval = mutable_state(null);
    let onMouseMove = () => {
    };
    ...
    onDestroy(() => {
      if (get$1(scrollCheckInterval)) {
        clearInterval(get$1(scrollCheckInterval));
        set(scrollCheckInterval, null);
      }
      window.removeEventListener("mousemove", onMouseMove);
      window.removeEventListener("mouseup", onMouseUp);
    });
    ...
    var node = first_child(fragment);
    {
      var consequent_1 = ($$anchor2) => {
        ...
        event("load", iframe, (e) => {
          ...
          set(scrollCheckInterval, setInterval(checkElement, 500));
          checkElement();
        });
